...
export default function Overlay({ isOpen, onClose, children }: OverlayProps) {
  ...
  return (
    <div className="flex justify-center fixed inset-0 z-50 sm:w-[42rem] sm:h-full sm:overflow-y-auto lg:relative lg:w-full lg:h-full ">
      <div className="flex justify-center items-center sm:h-full sm:w-full">
        <div className="bg-[#efecec] p-10 rounded-md relative sm:h-[33rem] sm:mt-20 w-full h-full">
          <button
            onClick={onClose}
